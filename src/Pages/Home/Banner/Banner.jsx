    ...
    <div className="relative pb-5">
      <AwesomeSlider>
        <div className="flex flex-col items-center justify-center h-100">
          <Fade>
            <img src="src/assets/download.jpeg" alt="Slider Image 1" />
        ...
        <div className="flex flex-col items-center justify-center h-40">
          <Fade>
            <img src="src/assets/download (2).jpeg" alt="Slider Image 2" />
        ...
        <div className="flex flex-col items-center justify-center h-40">
          <Fade>
            <img src="src/assets/download (1).jpeg" alt="Slider Image 3" />
